...
class Timer extends Component {
  ...
  render() {
    const {timeElapsedInSeconds, score, isTimerRunning} = this.state
            ...
            <ul className="navbarTop">
              ...
              <div className="div2">
                <div className="div22">
                  ...
                  <p className="lastNavPara">{score}</p>
                </div>
                ...
                <div className="div22">
                  ...
                  <p className="lastNavPara">{timeElapsedInSeconds} sec</p>
                </div>
              </div>
            </ul>
        ...
        {!isTimerRunning && (
          <>
            <div>
              ...
              <button onClick={this.onStartTimer} type="button">
                PLAY AGAIN
              </button>
            </div>
          </>
